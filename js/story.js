...
const berlinStories = {
    ...
    "2017":
        "The LED transition accelerates across Berlin's districts. To human eyes the city is better lit than ever — but the satellite sees something different.",

    "2019":
        "The LED conversion is largely complete. Satellite radiance readings have shifted, not because Berlin is darker, but because the sensor cannot see the light.",

    "2020":
        "COVID-19 lockdowns reduce activity across the city. For the first time, the satellite records a drop that reflects a real reduction in human activity rather than a technology shift.",

    "2022":
        "Russia cuts gas supplies to Europe. Berlin responds by switching off monument lighting across 200 landmarks — including the Brandenburg Gate, Charlottenburg Palace and the Victory Column. The energy crisis writes itself into the satellite data.",

    "2023":
        "The full annual impact of Berlin's emergency energy measures shows in the data — the sharpest single-year drop in the entire record. A war in Ukraine, visible from space.",

    "2024":
        "As the energy crisis eases, Berlin's nighttime signature begins to recover. But the 2022–2023 dip leaves a permanent mark in the record — proof that policy can change what satellites see.",

    "2025":
        "More than a decade of satellite observation reveals the full complexity of measuring light pollution — where the data tells the truth, where it misleads, and what we still cannot see from space."
...
const kyivStories = {
    ...
    "2021":
        "Kyiv's lights climbed steadily for years, the normal hum of a growing capital. Then, in 2022, the line breaks. Russia's invasion brought repeated, deliberate strikes on Ukraine's power plants and grid. Between February 2022 and May 2024, a total of 18 large-scale power plants were damaged or destroyed, along with hundreds of boiler houses and heating points and hundreds of kilometers of district heating pipes. By November 2022, Ukraine's grid operator reported that roughly 40% of the country was experiencing difficulties from damage to major energy hubs. The result was a sharp drop in Kyiv's satellite light, not because people left, but because the power simply wasn't there. Rolling blackouts, candlelit apartments, and city-run charging stations became part of daily life.",
